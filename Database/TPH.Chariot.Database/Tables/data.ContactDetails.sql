...
(
	[ContactDetailsID]			BIGINT							NOT NULL	CONSTRAINT [DF__ContactDetails__ContactDetailsID] DEFAULT (NEXT VALUE FOR [data].[SQ__ContactDetails])
	...
	, CONSTRAINT [PK__ContactDetails__ContactDetailsID] PRIMARY KEY ([ContactDetailsID])
);
GO
